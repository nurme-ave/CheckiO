...
print()
print(checkio2([1, 3, 5]))
print(checkio2([6]))
print(checkio2([0, 1, 2, 3, 4, 5]))
print(checkio2([0, 1, 2, 3, 4, 5]) == 30, "(0+2+4)*5=30")
print(checkio2([1, 3, 5]) == 30, "(1+5)*5=30")
print(checkio2([6]) == 36, "(6)*6=36")
print(checkio2([]) == 0, "An empty array = 0")
